...
public class SimpleHibernateDao<T, PK extends Serializable> {
	 ...
	 */
	public SimpleHibernateDao(@SuppressWarnings("hiding") final SessionFactory sessionFactory,
			@SuppressWarnings("hiding") final Class<T> entityClass) {
	 ...
	 */
	@Autowired
	public void setSessionFactory(@SuppressWarnings("hiding") final SessionFactory sessionFactory) {
		this.sessionFactory = sessionFactory;
	}
	...
	public List<T> getAll(String orderBy, boolean isAsc) {
		...
		Criterion criterion = Restrictions.eq("isUse", "Y");
		c.add(criterion);
		if (isAsc) {
